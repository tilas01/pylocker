def main():
    ...
    print("Message:\nThis project is being replaced by sdcrypt.\nPlease see this projects current README for more information.")
    print("sdcrypt: https://www.github.com/tilas01/sdcrypt\nREADME: https://github.com/tilas01/pylocker/blob/main/README.md\n")
    while True:
